...
namespace EmbeddedResources
{
    ...
    extern const unsigned char homingbullet_png[];
    extern const unsigned int homingbullet_png_size;
    ...
    extern const unsigned char boss2_png[];
    extern const unsigned int boss2_png_size;
    extern const unsigned char boss3P1_png[];
    extern const unsigned int boss3P1_png_size;
    extern const unsigned char boss3P2_png[];
    extern const unsigned int boss3P2_png_size;
    extern const unsigned char boss3P3_png[];
    extern const unsigned int boss3P3_png_size;
    extern const unsigned char boss3P4_png[];
    extern const unsigned int boss3P4_png_size;
    extern const unsigned char boss3P5_png[];
    extern const unsigned int boss3P5_png_size;
    extern const unsigned char boss3P6_png[];
...
void EmbeddedResourceManager::registerResources()
{
    ...
    _resources["sprites/homingbullet.png"] = {
        EmbeddedResources::homingbullet_png, EmbeddedResources::homingbullet_png_size};
    ...
    _resources["sprites/boss2.png"] = {EmbeddedResources::boss2_png, EmbeddedResources::boss2_png_size};
    _resources["sprites/boss3/boss3P1.png"] = {EmbeddedResources::boss3P1_png, EmbeddedResources::boss3P1_png_size};
    _resources["sprites/boss3/boss3P2.png"] = {EmbeddedResources::boss3P2_png, EmbeddedResources::boss3P2_png_size};
    _resources["sprites/boss3/boss3P3.png"] = {EmbeddedResources::boss3P3_png, EmbeddedResources::boss3P3_png_size};
    _resources["sprites/boss3/boss3P4.png"] = {EmbeddedResources::boss3P4_png, EmbeddedResources::boss3P4_png_size};
