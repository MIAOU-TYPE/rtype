...
namespace Resources
{
    ...
    class EmbeddedResourceManager : public IResourceManager {
      public:
         ...
         */
        ResourceData loadResource(const std::string &resourcePath) const noexcept override;
         ...
         */
        bool hasResource(const std::string &resourcePath) const noexcept override;

        /**
         * @brief Lists all available resources.
         * @return Vector of resource paths/identifiers.
         */
        std::vector<std::string> listResources() const noexcept override;
